...
const solutions = [
  {
    name: 'Alquiler',
    description: 'Realizar nuevo alquiler.',
    href: '#',
    icon: ChartBarIcon,
  },
  {
    name: 'Historial',
    description: 'Revisar el historial de alquileres vigentes.',
    href: '#',
    icon: ChartBarIcon,
  },
]
const callsToAction = [
  { name: 'Promoción', href: '#', icon: PlayIcon },
  { name: 'Contactos clientes', href: '#', icon: PhoneIcon },
]
const resources = [
  {
    name: 'Help Center',
